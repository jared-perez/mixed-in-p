...
<context>
    ...
    <message>
        ...
        <translation type="vanished">Версия 1.2.9</translation>
    </message>
    <message>
...
Features:
  ...
  - Key detection using Chroma analysis</source>
        <translatorcomment>FIXED: Russian uses native script for slicer/sample (слайсер/сэмпл); keep beat tracking and Chroma in English per updated glossary</translatorcomment>
        <translation type="vanished">Анализ аудиофайлов для определения BPM и музыкальной тональности.
Результаты отображаются в виде гармонических кодов тональности для удобного гармоничного микширования.

Возможности:
  - Пакетное переименование файлов с отменой
  - Редактирование метаданных
  - Плеер со встроенным слайсером для извлечения сэмплов
  - Гармоническая клавиатура
  - Определение BPM с помощью beat tracking
  - Определение тональности с помощью Chroma-анализа</translation>
    </message>
    <message>
...
Возможности:
  ...
  - Гармоническая клавиатура
  - Определение BPM с помощью beat tracking
  - Определение тональности с помощью Chroma-анализа
  - Анализатор спектра</translation>
    ...
    <message>
        ...
        <translation type="vanished">&lt;div style=&quot;color: {p}; font-size: 13px; line-height: 1.6; text-align: center;&quot;&gt;Перетащите файлы на панели или на боковую панель.&lt;br&gt;&lt;br&gt;&lt;span style=&quot;color: {y}; font-weight: bold;&quot;&gt;ПЕРЕИМЕНОВАНИЕ&lt;/span&gt; — Сначала приведите имена файлов в порядок&lt;br&gt;&lt;span style=&quot;color: {s};&quot;&gt;обрезка, префикс, предпросмотр перед применением&lt;/span&gt;&lt;br&gt;&lt;span style=&quot;color: {s};&quot;&gt;↓&lt;/span&gt;&lt;br&gt;&lt;span style=&quot;color: {y}; font-weight: bold;&quot;&gt;КОНВЕРТАЦИЯ&lt;/span&gt; — Смена форматов&lt;br&gt;&lt;span style=&quot;color: {s};&quot;&gt;WAV ↔ FLAC ↔ AIFF ↔ MP3&lt;/span&gt;&lt;br&gt;&lt;span style=&quot;color: {s};&quot;&gt;↓&lt;/span&gt;&lt;br&gt;&lt;span style=&quot;color: {y}; font-weight: bold;&quot;&gt;АНАЛИЗ&lt;/span&gt; — Определяет BPM, тональность и энергию&lt;br&gt;&lt;span style=&quot;color: {s};&quot;&gt;автоматически записывает теги и переименовывает за один раз&lt;/span&gt;&lt;br&gt;&lt;br&gt;Включите шаг &lt;span style=&quot;color: {y};&quot;&gt;пайплайна&lt;/span&gt; в любой панели, чтобы прогнать пакет целиком.&lt;/div&gt;</translation>
    </message>
    <message>
        ...
        <translation>&lt;div style=&quot;color: {p}; font-size: 13px; line-height: 1.6; text-align: center;&quot;&gt;Перетащите файлы на панели или на боковую панель.&lt;br&gt;&lt;br&gt;&lt;span style=&quot;color: {y}; font-weight: bold;&quot;&gt;ПЕРЕИМЕНОВАНИЕ&lt;/span&gt; — Сначала приведите имена файлов в порядок&lt;br&gt;&lt;span style=&quot;color: {s};&quot;&gt;обрезка, префикс, предпросмотр перед применением&lt;/span&gt;&lt;br&gt;&lt;span style=&quot;color: {s};&quot;&gt;↓&lt;/span&gt;&lt;br&gt;&lt;span style=&quot;color: {y}; font-weight: bold;&quot;&gt;КОНВЕРТАЦИЯ&lt;/span&gt; — Смена форматов&lt;br&gt;&lt;span style=&quot;color: {s};&quot;&gt;WAV ↔ FLAC ↔ AIFF ↔ MP3&lt;/span&gt;&lt;br&gt;&lt;span style=&quot;color: {s};&quot;&gt;↓&lt;/span&gt;&lt;br&gt;&lt;span style=&quot;color: {y}; font-weight: bold;&quot;&gt;АНАЛИЗ&lt;/span&gt; — Определяет BPM, тональность и энергию&lt;br&gt;&lt;span style=&quot;color: {s};&quot;&gt;автоматически записывает теги и переименовывает за один раз&lt;/span&gt;&lt;/div&gt;</translation>
    </message>
    <message>
        ...
        <translation>&lt;div style=&quot;color: {p}; font-size: 13px; line-height: 1.6; text-align: center;&quot;&gt;Включите шаг &lt;span style=&quot;color: {y};&quot;&gt;пайплайна&lt;/span&gt; в любой панели, чтобы прогнать пакет целиком.&lt;/div&gt;</translation>
    </message>
    <message>
...
Features:
  ...
  - Spectrum analyzer</source>
        ...
        <translation>Анализ аудиофайлов для определения BPM и музыкальной тональности.
Результаты отображаются в виде гармонических кодов тональности для удобного гармоничного микширования.
...
Возможности:
  ...
  - Анализатор спектра</translation>
    ...
    <message>
        ...
        <translatorcomment>FIXED: Russian heading uses native script (СЛАЙСЕР) to match the other Cyrillic section headings</translatorcomment>
        <translation type="vanished">&lt;div style=&quot;color: {p}; font-size: 13px; line-height: 1.7; text-align: center;&quot;&gt;&lt;span style=&quot;color: {y}; font-weight: bold;&quot;&gt;СЛАЙСЕР&lt;/span&gt; — Возьмите фрагмент из любого трека.&lt;br&gt;&lt;span style=&quot;color: {s};&quot;&gt;Задайте начало/конец ползунком диапазона или отметьте&lt;br&gt;границы во время воспроизведения. Сдвиг ±10 мс.&lt;/span&gt;&lt;br&gt;&lt;br&gt;&lt;span style=&quot;color: {y}; font-weight: bold;&quot;&gt;ПЛЕЕР&lt;/span&gt; — Встроенное воспроизведение с плейлистом.&lt;br&gt;&lt;span style=&quot;color: {s};&quot;&gt;Перетаскивайте для изменения порядка. Щёлкните трек&lt;br&gt;правой кнопкой в Анализе, чтобы отправить его сюда.&lt;/span&gt;&lt;br&gt;&lt;br&gt;&lt;span style=&quot;color: {y}; font-weight: bold;&quot;&gt;МЕТАДАННЫЕ&lt;/span&gt; — Перетащите файл, редактируйте его теги.&lt;br&gt;&lt;span style=&quot;color: {s};&quot;&gt;Автосохранение при переходе дальше.&lt;/span&gt;&lt;br&gt;&lt;br&gt;&lt;span style=&quot;color: {y}; font-weight: bold;&quot;&gt;КЛАВИАТУРА&lt;/span&gt; — Играйте ноты в любой тональности.&lt;br&gt;&lt;span style=&quot;color: {s};&quot;&gt;Гармоническая полоса тональностей прямо здесь для справки.&lt;/span&gt;&lt;br&gt;&lt;br&gt;&lt;span style=&quot;color: {y}; font-weight: bold;&quot;&gt;НАСТРОЙКИ&lt;/span&gt; — Диапазон BPM, формат тональности,&lt;br&gt;&lt;span style=&quot;color: {s};&quot;&gt;правила автопереименования.&lt;/span&gt;&lt;/div&gt;</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation type="vanished">Отправить в Конвертацию</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Нажмите в любом месте, чтобы закрыть</translation>
    </message>
</context>
<context>
...
or click “Add Artwork…”</source>
        <translation>Нет обложки

Перетащите изображение сюда
или нажмите «Добавить обложку…»</translation>
    </message>
    <message>
        <location filename="../widgets/artwork_widget.py" line="165"/>
        <source>Remove Artwork</source>
        <translatorcomment>«обложка» — как в «Добавить обложку…».</translatorcomment>
    ...
    <message>
        ...
        <translation>Нажмите, чтобы увеличить. Правый клик — больше действий.</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Потяните вверх или вниз, чтобы изменить темп</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Громкость клика — нажмите, чтобы выбрать тихо / средне / громко</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation type="vanished">Файлы с потерями не допускаются</translation>
    </message>
    <message>
...
{error}</source>
        <translation>Не удалось сохранить конвертированные файлы в {folder}.
...
{error}</translation>
    ...
    <message>
        ...
        <translation>Выберите более низкий битрейт, чтобы конвертировать этот файл.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>MP3 можно превратить только в MP3 с более низким битрейтом.</translation>
    </message>
    <message>
        <location filename="../widgets/conversion_panel.py" line="993"/>
        <source>Lossy files can&apos;t be converted.</source>
        <translation>Файлы с потерями нельзя конвертировать.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="vanished">({count} с потерями пропущено)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Повторяющиеся треки</translation>
    </message>
    <message numerus="yes">
        <location filename="../widgets/dialogs/duplicate_policy.py" line="191"/>
        <source>%n track(s) are already in &quot;{0}&quot;.</source>
        <translation>
            <numerusform>%n трек уже есть в «{0}».</numerusform>
            <numerusform>%n трека уже есть в «{0}».</numerusform>
            <numerusform>%n треков уже есть в «{0}».</numerusform>
        </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="vanished">Добавляет файлы на панель, которую вы сейчас просматриваете</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="vanished">Добавляет файлы из папки на панель, которую вы сейчас просматриваете</translation>
    </message>
</context>
<context>
...
{1}</translation>
    ...
    <message>
        ...
        <translation type="vanished">0 сессий</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>СОВМЕСТИМО С</translation>
    </message>
    <message>
        <location filename="../widgets/key_info_box.py" line="109"/>
        <source>Press a key to see harmonic info…</source>
        <translation>Нажмите клавишу, чтобы увидеть гармоническую информацию…</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Квинтовый круг</translation>
    </message>
    <message>
        <location filename="../widgets/keyboard_panel.py" line="684"/>
        <source>Hex Grid</source>
        <translation>Шестиугольная сетка</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Добавьте токен Discogs в настройках, чтобы искать сведения о треках.</translation>
    </message>
    <message>
        ...
        <translation>Discogs отклонил этот токен. Проверьте его в настройках или создайте новый.</translation>
    </message>
    <message>
        ...
        <translation>Discogs ограничивает частоту запросов. Подождите минуту и повторите попытку.</translation>
    </message>
    <message>
        ...
        <translation>На Discogs не нашлось совпадений для этого трека. Обычно помогает исправить поля «Исполнитель» и «Название» и повторить поиск.</translation>
    </message>
    <message>
        <location filename="../lookup_flow.py" line="74"/>
        <source>Discogs is having trouble right now. Try again later.</source>
        <translation>Сейчас у Discogs неполадки. Повторите попытку позже.</translation>
    </message>
    <message>
        <location filename="../lookup_flow.py" line="78"/>
        <source>Couldn&apos;t reach Discogs. Check your internet connection.</source>
        <translation>Не удалось связаться с Discogs. Проверьте подключение к интернету.</translation>
    </message>
    <message>
        <location filename="../lookup_flow.py" line="81"/>
        <source>Couldn&apos;t read Discogs&apos; answer. Try again later.</source>
        <translation>Не удалось прочитать ответ Discogs. Повторите попытку позже.</translation>
    </message>
    <message>
        <location filename="../lookup_flow.py" line="159"/>
        <source>Couldn&apos;t write these tags: {0}</source>
        <translation>Не удалось записать эти теги: {0}</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Найти обложку в интернете</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Выберите издание с нужной обложкой.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>На Discogs нет обложки для этого издания — попробуйте другое.</translation>
    </message>
    <message>
...
{0}</translation>
    ...
    <message>
        ...
        <translation>Файлы с потерями остаются в «Конвертации» — причина указана в их статусе.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translatorcomment>Terminology: &quot;пайплайн&quot; rather than &quot;цепочка&quot; — what Russian producers and developers actually say, and it keeps the surf-break reading the app&apos;s wave symbol depends on.</translatorcomment>
        <translation type="vanished">Файлы с потерями остаются в «Конвертации» — пайплайн конвертирует только источники без потерь.</translation>
    </message>
    <message>
        <source>Renaming files...</source>
        <translation type="vanished">Переименование файлов...</translation>
    </message>
    <message>
        <source>Renamed {0} files</source>
        <translation type="vanished">Переименовано {0} файлов</translation>
    ...
    <message>
        ...
        <translation type="vanished">Отменено {0} файлов</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation type="vanished">Перетащите один аудиофайл для просмотра и редактирования его тегов метаданных.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Показать этот файл в Finder / Проводнике.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Найти сведения об этом треке на Discogs и проверить их.</translation>
    </message>
    <message>
        ...
        <translation>Открыть издание</translation>
    </message>
    <message>
        ...
        <translation>Открыть страницу этого издания на Discogs в браузере.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Обновить с Discogs</translation>
    </message>
    <message>
        ...
        <translation>Перечитать это издание и показать, что о нём знает Discogs.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Найти на Discogs и выбрать, обложку какого издания использовать.</translation>
    </message>
    <message>
        ...
        <translation>Уже записано в теги этого файла.</translation>
    </message>
    <message>
        ...
        <translation>Записать это значение в тег «{0}».</translation>
    </message>
    <message>
        ...
        <translation>Записать название и номер трека из этой строки в теги.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Перетащите один аудиофайл для просмотра и редактирования его тегов метаданных. Щёлкните правой кнопкой по треку в плейлисте → Открыть на панели метаданных</translation>
    </message>
    <message>
        ...
        <translation>Настройка Discogs</translation>
    </message>
    <message>
        ...
        <translation>Открывает настройки Discogs, где включается поиск в интернете.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>В коллекциях</translation>
    </message>
    <message>
        ...
        <translation>В списках желаний</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Воспроизвести в Плеере</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>В этом файле нет тегов — найти его на Discogs?</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>В этом файле нет ни исполнителя, ни названия для поиска, и имя файла их не даёт. Заполните поле «Название» и повторите попытку.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Применено из Discogs</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Щелчок везде</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Удерживайте, чтобы придержать бит</translation>
    </message>
    <message>
        <location filename="../widgets/metronome_view.py" line="594"/>
        <source>Hold to push the beat forward</source>
        <translation>Удерживайте, чтобы подтолкнуть бит</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="vanished">Фон: форма волны</translation>
    </message>
    <message>
        <source>Backdrop oscilloscope</source>
        <translation type="vanished">Фон: осциллограф</translation>
    </message>
    <message>
        <source>Backdrop spectrum</source>
        <translation type="vanished">Фон: спектр</translation>
    </message>
    <message>
        <source>Backdrop fire</source>
        <translation type="vanished">Фон: огонь</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="vanished">Фон: червоточина</translation>
    </message>
    <message>
...
{0}</translation>
    ...
    <message numerus="yes">
        ...
        <translation>
            ...
            <numerusform>%n из выбранных файлов были перемещены.</numerusform>
            <numerusform>%n из выбранных файлов были перемещены.</numerusform>
        </translation>
    </message>
    <message>
    ...
    <message numerus="yes">
        ...
        <translation>
            ...
            <numerusform>Для %n треков не найдено совпадений.</numerusform>
            <numerusform>Для %n треков не найдено совпадений.</numerusform>
        </translation>
    </message>
    <message numerus="yes">
        ...
        <translation>
            ...
            <numerusform>Обновлено %n трека.</numerusform>
            <numerusform>Обновлено %n треков.</numerusform>
        </translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Удалить папку «{0}» и всё её содержимое?</translation>
    </message>
    <message>
        <location filename="../widgets/playlist_tree.py" line="941"/>
        <source>Delete playlist &quot;{0}&quot;?</source>
        <translation>Удалить плейлист «{0}»?</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Экспортировать и скопировать треки…</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Этот плейлист пуст — экспортировать нечего.</translation>
    </message>
    <message>
...
{1}</source>
        <translation>Экспортировано треков: {0} в:
{1}</translation>
    </message>
    <message>
...
{2}</translation>
    ...
    <message>
        ...
        <source>Export and Copy Tracks</source>
        <translation>Экспорт с копированием треков</translation>
    </message>
    <message>
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n трек не найден и был пропущен.</numerusform>
            <numerusform>%n трека не найдены и были пропущены.</numerusform>
            <numerusform>%n треков не найдены и были пропущены.</numerusform>
        </translation>
    </message>
    <message>
...
{0}</translation>
    ...
    <message>
        ...
        <translation>Serato — перетащите файл на панель crates</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Как его импортировать:</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Закрыть фильтр плейлистов</translation>
    </message>
    <message>
        <location filename="../widgets/playlist_tree.py" line="1826"/>
        <source>Filter playlists by name</source>
        <translation>Фильтровать плейлисты по названию</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Добавьте файлы сюда, чтобы поставить их в очередь на анализ. Используйте кнопки ниже, чтобы отправить их на анализ.</translation>
    </message>
    <message>
        <location filename="../widgets/queue_panel.py" line="50"/>
        <source>Drop audio files here to add to queue</source>
        <translation>Перетащите аудиофайлы сюда, чтобы добавить в очередь</translation>
    </message>
    <message>
        <location filename="../widgets/queue_panel.py" line="79"/>
        <source>0 files in queue</source>
        <translation>0 файлов в очереди</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Этого файла больше нет там, где его ожидает плейлист:</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Просмотреть папку и заново связать каждый найденный в ней отсутствующий файл</translation>
    </message>
    <message>
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>В ваших плейлистах отсутствует ещё %n файл.</numerusform>
            <numerusform>В ваших плейлистах отсутствуют ещё %n файла.</numerusform>
            <numerusform>В ваших плейлистах отсутствуют ещё %n файлов.</numerusform>
        </translation>
    </message>
    <message>
...
{0}</translation>
    ...
    <message>
        ...
        <translation>В этой папке не найдено подходящих файлов.</translation>
    </message>
    <message>
        <location filename="../widgets/dialogs/relocate_dialog.py" line="267"/>
        <source>Could not search that folder:
{0}</source>
        <translation>Не удалось выполнить поиск в этой папке:
{0}</translation>
    </message>
    <message numerus="yes">
        ...
        <translation>
            <numerusform>Повторно связан %n файл.</numerusform>
            <numerusform>Повторно связаны %n файла.</numerusform>
            <numerusform>Повторно связаны %n файлов.</numerusform>
        </translation>
    </message>
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n из них найден по имени файла, а не по содержимому — проверьте, что это ожидаемый трек.</numerusform>
            <numerusform>%n из них найдены по имени файла, а не по содержимому — проверьте, что это ожидаемые треки.</numerusform>
            <numerusform>%n из них найдены по имени файла, а не по содержимому — проверьте, что это ожидаемые треки.</numerusform>
        </translation>
    </message>
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n файл всё ещё отсутствует.</numerusform>
            <numerusform>%n файла всё ещё отсутствуют.</numerusform>
            <numerusform>%n файлов всё ещё отсутствуют.</numerusform>
        </translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Перезапустите для применения изменений языка.</translation>
    </message>
    <message>
        ...
        <translation>Аудиоплеер по умолчанию</translation>
    </message>
    <message>
        <location filename="../widgets/settings_panel.py" line="122"/>
        <source>Make Mixed in P your default audio player</source>
        <translation>Сделать Mixed in P аудиоплеером по умолчанию</translation>
    </message>
    <message>
        ...
        <translation>Открывает «Параметры» Windows на записи Mixed in P, где можно назначить ему ваши типы аудиофайлов. Windows разрешает сделать этот выбор только вам.</translation>
    </message>
    <message>
        ...
        <translation>Двойной щелчок по аудиофайлу будет открывать его здесь. Вернуть прежнюю программу можно в окне «Свойства» в Finder.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="vanished">Тёмная ночь</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Перезапустите для применения изменений темы.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Цвет полной формы волны в плеере.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Использовать стандартный цвет формы волны из темы</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Размер текста плейлиста</translation>
    </message>
    <message>
        ...
        <translation>Размер строк треков в плеере. Применяется сразу.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Обложка в плейлисте</translation>
    </message>
    <message>
        ...
        <translation>Часть обложки, показываемая в столбце «Обложка» плеера. «Целиком» увеличивает высоту строк под всю обложку.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="vanished">Визуализации</translation>
    </message>
    <message>
        <source>Enable audio visualizations</source>
        <translation type="vanished">Включить визуализации звука</translation>
    </message>
    <message>
        <source>Adds a visuals selector to the Player and an animated waveform while analyzing or converting.</source>
        <translation type="vanished">Добавляет в плеер выбор визуализаций и показывает анимированную форму волны во время анализа или конвертации.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Автоматически записывать BPM в теги после анализа</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Одновременно может быть активна только одна нотация. Применяется к тональности, записываемой в теги/имена файлов при анализе, и к подписям клавиш на панели Клавиатуры.</translation>
    </message>
    <message>
        <location filename="../widgets/settings_panel.py" line="572"/>
        <source>👑 Key Codes  (8A, 5A, 2B)</source>
        <translation>👑 Коды тональности  (8A, 5A, 2B)</translation>
    </message>
    <message>
        <location filename="../widgets/settings_panel.py" line="573"/>
        <source>Traditional Key Notation  (Am, Ebm, F#…)</source>
        <translation>Традиционная нотация тональностей  (Am, Ebm, F#…)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Если в комментарий записываются и энергия, и тональность, энергия указывается первой, а тональность — второй.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Сохраняет энергию там, где её можно точно прочитать обратно, а не разбирать комментарий.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Всегда добавлять дубликаты</translation>
    </message>
    <message>
        <location filename="../widgets/settings_panel.py" line="766"/>
        <source>Always skip duplicates</source>
        <translation>Всегда пропускать дубликаты</translation>
    </message>
    <message>
        ...
        <translation>Что происходит, когда вы добавляете трек, который плейлист уже содержит. В сет-листе трек может повторяться намеренно, поэтому программа спрашивает, а не решает за вас — выберите один из других вариантов, чтобы вопрос больше не появлялся.</translation>
    </message>
    <message>
        <location filename="../widgets/settings_panel.py" line="788"/>
        <source>Keep Scratch between sessions</source>
        <translation>Сохранять Scratch между сеансами</translation>
    </message>
    <message>
        ...
        <translation>Scratch — это рабочий список, с которого открывается плеер, и при каждом запуске он пуст. Включите этот параметр, чтобы он открывался с прежним содержимым: в любом случае «Сохранить плейлист» сохраняет копию.</translation>
    </message>
    <message>
        <location filename="../widgets/settings_panel.py" line="805"/>
        <source>Always use full paths in exported playlists</source>
        <translation>Всегда использовать полные пути в экспортированных плейлистах</translation>
    </message>
    <message>
        ...
        <translation>Экспортированные плейлисты используют пути относительно файла плейлиста, когда треки лежат рядом с ним, поэтому папка, которую вы упакуете и отправите, будет работать и на компьютере другого человека. Включите этот параметр, чтобы всегда записывать полный путь.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>Slate</source>
        <translatorcomment>Not the literal &apos;slanets&apos;: as a noun it reads as the rock and colloquially means flip-flops. &apos;Grafit&apos; is the idiomatic colour word for a dark blue-grey theme.</translatorcomment>
        <translation>Графит</translation>
    </message>
    <message>
        <location filename="../widgets/settings_panel.py" line="188"/>
        <source>Waveform / Visuals</source>
        <translatorcomment>Обе части взяты из уже переведённых строк «Форма волны» и «Визуализации».</translatorcomment>
    ...
    <message>
        ...
        <translation>Один цвет для всей формы волны.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Яркость цвета следует за громкостью.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="vanished">Красный — басы, зелёный — высокие, синий — средние.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Цвет следует за балансом басов и высоких.</translation>
    </message>
    <message>
        <source>Frequency bands and Tone choose their own colors.</source>
        <translation type="vanished">Частотные полосы и Тон выбирают цвета сами.</translation>
    </message>
    <message>
        <location filename="../widgets/settings_panel.py" line="266"/>
        <source>This track</source>
        <translation>Этот трек</translation>
    </message>
    <message>
        <location filename="../widgets/settings_panel.py" line="270"/>
        <source>Fixed</source>
        <translation>Единая</translation>
    </message>
    <message>
        ...
        <translation>«Единая» окрашивает все треки по одной шкале, чтобы их можно было сравнивать.</translation>
    </message>
    <message>
        <source>Show half waveform</source>
        <translation type="vanished">Половина формы волны</translation>
    </message>
    <message>
        <source>Show full waveform</source>
        <translation type="vanished">Полная форма волны</translation>
    </message>
    <message>
        <location filename="../widgets/settings_panel.py" line="373"/>
        <source>Enable large menu text</source>
        <translation>Включить крупный текст меню</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>По умолчанию выключено: пока вы не включите, приложение не обращается к сети. При поиске отправляются только исполнитель и название выбранного трека — никогда ваше аудио и никогда ваша библиотека. BPM, тональность и энергия всегда берутся из собственного анализа приложения.</translation>
    </message>
    <message>
        <location filename="../widgets/settings_panel.py" line="709"/>
        <source>Discogs token:</source>
        <translation>Токен Discogs:</translation>
    </message>
    <message>
        <location filename="../widgets/settings_panel.py" line="715"/>
        <source>Paste your token</source>
        <translation>Вставьте свой токен</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Чтобы Discogs присылал обложки и отвечал на полной скорости, нужен бесплатный личный токен. Он даёт доступ только на чтение, и его можно отозвать в любой момент в вашем аккаунте Discogs.</translation>
    </message>
    <message>
        <location filename="../widgets/settings_panel.py" line="734"/>
        <source>Fetch cover art with lookups</source>
        <translation>Загружать обложку при поиске</translation>
    </message>
    <message>
        ...
        <translation>Показывает обложку издания рядом с обложкой вашего файла, чтобы их можно было сравнить. Ничего не записывается, пока вы не подтвердите.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Возвращает все настройки к исходным. Язык, тема и расположение окна сохраняются, как и аудиоплеер по умолчанию — им распоряжается система.</translation>
    </message>
    <message>
        <location filename="../widgets/settings_panel.py" line="972"/>
        <source>Put every setting back to the way it shipped?</source>
        <translation>Вернуть все настройки к исходным?</translation>
    </message>
    <message>
        ...
        <translation>Язык, тема и расположение окна сохранятся. Токен Discogs будет удалён. Отменить это нельзя.</translation>
    </message>
    <message>
        <location filename="../widgets/settings_panel.py" line="1008"/>
        <source>Mixed in P now opens your audio files.</source>
        <translation>Аудиофайлы теперь открываются в Mixed in P.</translation>
    </message>
    <message>
        ...
        <translation>Mixed in P не зарегистрирован в Windows. Переустановка зарегистрирует его.</translation>
    </message>
    <message>
        ...
        <translation>Не удалось открыть «Параметры» Windows. Это можно настроить там самостоятельно: «Приложения → Приложения по умолчанию».</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Использовать оттенки выбранного цвета</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Изменение языка вступит в силу при следующем перезапуске Mixed in P.</translation>
    </message>
    <message>
        ...
        <translation>Изменение темы вступит в силу при следующем перезапуске Mixed in P.</translation>
    </message>
</context>
<context>
    <name>Sidebar</name>
...
<context>
    ...
    <message>
        ...
        <translation>Скрыть обложку</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translatorcomment>FIXED: Russian uses native script for slicer (Слайсер) per updated glossary</translatorcomment>
        <translation type="vanished">▸  Слайсер волновых петель</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translatorcomment>Shortened from the old &apos;Слайсер волновых петель&apos; — the waveform half of the name now belongs to the button beside it.</translatorcomment>
        <translation>Слайсер петель</translation>
    </message>
    <message>
        <location filename="../widgets/slice_section.py" line="215"/>
        <source>Slice start time (m:ss:mmm) — type to set</source>
        <translation>Время начала фрагмента (m:ss:mmm) — введите, чтобы задать</translation>
    </message>
    <message>
        <location filename="../widgets/slice_section.py" line="224"/>
        <source>Slice end time (m:ss:mmm) — type to set</source>
        <translation>Время конца фрагмента (m:ss:mmm) — введите, чтобы задать</translation>
    </message>
    <message>
        <location filename="../widgets/slice_section.py" line="226"/>
        <location filename="../widgets/slice_section.py" line="233"/>
        <source>Mark</source>
        <translatorcomment>FIXED: action button — infinitive command form, not the noun «Метка» (a mark)</translatorcomment>
    ...
    <message>
        ...
        <translation>Зациклить воспроизведение между маркерами начала и конца (L)</translation>
    </message>
    <message>
        <source>Loop playback between the start and end markers</source>
        <translation type="vanished">Зациклить воспроизведение между маркерами начала и конца</translation>
    </message>
    <message>
        <location filename="../widgets/slice_section.py" line="311"/>
        <source>Jump playhead to start marker (S)</source>
        <translation>Перейти к маркеру начала (S)</translation>
    </message>
    <message>
        <location filename="../widgets/slice_section.py" line="325"/>
        <source>Save Slice As:</source>
        <translation>Сохранить фрагмент как:</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>Slice</source>
        <translatorcomment>FIXED: action button — infinitive command form, not the noun «Слайсер» (slicer)</translatorcomment>
...
<context>
    ...
    <message>
        ...
        <translation>Перетащите один аудиофайл для просмотра его спектра</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>Перетащите один аудиофайл, чтобы увидеть его акустический спектр. Частота идёт снизу (0 Hz) вверх (Найквист); время идёт слева направо; цвет показывает амплитуду. Удобно для обнаружения срезов фильтра низких частот при кодировании с потерями.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Диапазон {0} dB</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось проанализировать этот файл.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Mixed in P уже запущен</translation>
    </message>
    <message>
        ...
        <translation>Запущенная копия не ответила, поэтому эти файлы не были открыты. Переключитесь на неё и добавьте их там.</translation>
    </message>
</context>
</TS>
